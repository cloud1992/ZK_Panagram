...
import { PANAGRAM_CONTRACT_ADDRESS } from "../constants";
...
export default function Input() {
  ...
  return (
  <div>
    {/* Mostrar error si existe, pero no ocultar el formulario */}
    {proofError && (
      <div className="text-red-600 text-center mb-4 p-4 bg-red-50 border border-red-200 rounded-lg">
        <p>There was an error generating the proof. Please try again.</p>
      </div>
    )}
